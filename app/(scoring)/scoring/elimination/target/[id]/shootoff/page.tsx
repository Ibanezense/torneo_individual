...
export default function ShootoffPage() {
    ...
    const advanceWinner = async (completedMatch: MatchData, winningArcherId: string) => {
        ...
        if (nextMatch) {
            ...
            const updateData: Record<string, string | null | number> = isOddPosition
            ...
            const nextArcher1Id = isOddPosition ? winningArcherId : nextMatch.archer1_id;
            const nextArcher2Id = isOddPosition ? nextMatch.archer2_id : winningArcherId;
